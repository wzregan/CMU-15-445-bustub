...
TEST(LockManagerTest, ENABLE_TableLockTest1) { TableLockTest1(); }  // NOLINT
...
TEST(LockManagerTest, ENABLE_TableLockUpgradeTest1) { TableLockUpgradeTest1(); }  // NOLINT
...
TEST(LockManagerTest, ENABLE_RowLockTest1) { RowLockTest1(); }  // NOLINT
...
TEST(LockManagerTest, ENABLE_TwoPLTest1) { TwoPLTest1(); }  // NOLINT
