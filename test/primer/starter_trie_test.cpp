...
TEST(StarterTest, ENABLED_TrieNodeInsertTest) {
  // Test Insert
...
TEST(StarterTest, ENABLE_TrieNodeRemoveTest) {
  auto t = TrieNode('a');
...
TEST(StarterTest, ENABLE_TrieInsertTest) {
  {
    Trie trie;
...
TEST(StarterTrieTest, ENABLE_RemoveTest) {
  {
    Trie trie;
    bool success = trie.Insert<int>("a", 5);
    EXPECT_EQ(success, true);
...
TEST(StarterTrieTest, ENABLE_ConcurrentTest1) {
  Trie trie;
